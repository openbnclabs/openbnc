# openbnc ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for openbnc edge scenarios on ESP32.
...
3. Connect UI state with openbnc edge/runtime messaging
...
- [openbnc Hardware Design](../../docs/hardware-peripherals-design.md)
