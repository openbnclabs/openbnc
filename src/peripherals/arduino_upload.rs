...
//! sketch code and calls this tool. openbnc compiles and uploads it — no
...
impl Tool for ArduinoUploadTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let sketch_name = "openbnc_sketch";
        let temp_dir = std::env::temp_dir().join(format!("openbnc_{}", uuid::Uuid::new_v4()));
