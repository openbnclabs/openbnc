...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(openbnc_dir);
...
pub fn secret_file_path(openbnc_dir: &Path) -> PathBuf {
    openbnc_dir.join(OTP_SECRET_FILE)
}
