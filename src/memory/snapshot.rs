...
const SNAPSHOT_HEADER: &str = "# 🧠 openbnc Memory Snapshot\n\n\
    > Auto-generated by openbnc. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 openbnc Memory Snapshot

> Auto-generated by openbnc.
...
I am openbnc, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 openbnc Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
