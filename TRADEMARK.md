# openbnc Trademark Policy

**Effective date:** February 2026  
**Maintained by:** openbnc Labs

---

## Our Trademarks

The following are trademarks of openbnc Labs:

- **openbnc** (word mark)
- **openbnclabs** (organization name)
- The openbnc logo and associated visual identity

These marks identify the official openbnc project and distinguish it from
...
The **only** official openbnc repository is:

> https://github.com/openbnclabs/openbnc

Any other repository, organization, domain, or product claiming to be
"openbnc" or implying affiliation with openbnc Labs is unauthorized and
may constitute trademark infringement.

**Known unauthorized forks:**
- `openagen/openbnc` — not affiliated with openbnc Labs

If you encounter an unauthorized use, please report it by opening an issue
at https://github.com/openbnclabs/openbnc/issues.

---

## Permitted Uses

You **may** use the openbnc name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   openbnc, provided it is clear your project is not the official openbnc.

2. **Descriptive reference** — referring to openbnc in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of openbnc"
...
You **may not** use the openbnc name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by openbnc Labs.

2. **Cause brand confusion** — use "openbnc" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official openbnc project.

4. **Misrepresent origin** — remove or obscure attribution to openbnc Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from openbnc Labs.
...
you fork openbnc, you must:

- Clearly state your project is a fork of openbnc
- Link back to the official repository
- Not use "openbnc" as the primary name of your fork
...
Contributors to the official openbnc repository are protected under the
...
If you believe someone is infringing openbnc trademarks:

1. Open an issue at https://github.com/openbnclabs/openbnc/issues
...
openbnc Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the openbnc name and brand.*
