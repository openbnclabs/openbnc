...
//!
//! Ref: https://github.com/openbnclabs/openbnc/issues/618 (item 6)
...
use openbnc::agent::dispatcher::{NativeToolDispatcher, XmlToolDispatcher};
use openbnc::agent::memory_loader::MemoryLoader;
use openbnc::config::MemoryConfig;
use openbnc::memory;
use openbnc::memory::Memory;
use openbnc::observability::{NoopObserver, Observer};
use openbnc::providers::traits::ChatMessage;
use openbnc::providers::{
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: openbnc"));
...
async fn e2e_live_openai_codex_multi_turn() {
    use openbnc::providers::openai_codex::OpenAiCodexProvider;
    use openbnc::providers::traits::Provider;
