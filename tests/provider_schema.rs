...
use openbnc::providers::compatible::AuthStyle;
use openbnc::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use openbnc::providers::compatible::OpenAiCompatibleProvider;
