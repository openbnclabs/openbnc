# openbnc Contributor License Agreement (CLA)
...
property rights granted by contributors to openbnc Labs. This agreement
protects both contributors and users of the openbnc project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the openbnc repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to openbnc Labs
  for inclusion in the openbnc project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"openbnc Labs"** means the maintainers and organization responsible
  for the openbnc project at https://github.com/openbnclabs/openbnc.

---

## 2. Grant of Copyright License

You grant openbnc Labs and recipients of software distributed by openbnc
...
openbnc that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to openbnc
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with openbnc Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the openbnc name,
...
openbnc Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the openbnc project are licensed under
both:
...
By opening a pull request or submitting a patch to the openbnc repository,
...
https://github.com/openbnclabs/openbnc/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the openbnc dual-license model.*
