//! # openbnc Robot Kit
//!
//! A standalone robotics toolkit that integrates with openbnc for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  openbnc AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use openbnc_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of openbnc. It defines its own
//! `Tool` trait that is compatible with openbnc's but doesn't require it.
//!
//! ## Safety
//!
