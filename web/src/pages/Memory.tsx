    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-gray-900 text-sm font-medium px-4 py-2 rounded-lg transition-colors"
        >
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-gray-900 text-sm font-medium rounded-lg transition-colors"
        >
          Search
        </button>
      </div>
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                onClick={handleAdd}
                disabled={submitting}
                className="px-4 py-2 text-sm font-medium text-gray-900 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors disabled:opacity-50"
              >
