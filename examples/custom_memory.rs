//! Example: Implementing a custom Memory backend for openbnc
//!
...
// ── Re-define the trait types (in your app, import from openbnc::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 openbnc Memory Demo — InMemoryBackend\n");
