...
```bash
# Check config
cat ~/.openbnc/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time openbnc channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   openbnc daemon
   # or
   RUST_LOG=info openbnc channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/openbnc/issues
