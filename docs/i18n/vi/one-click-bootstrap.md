...
Cách cài đặt và khởi tạo openbnc nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài openbnc), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image openbnc cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.openbnc-docker`.
