# openbnc PR Workflow (High-Volume Collaboration)

This document defines how openbnc handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to openbnc/project-native labels.
...
- Confirm any required identity-like wording uses openbnc/project-native terminology.
