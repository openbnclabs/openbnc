...
|---------|-----------|--------------|--------|
| **Base openbnc** | 3.4MB | <5MB | ✅ Current |
...
| Hardware | RAM | openbnc (base) | openbnc (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, openbnc uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### openbnc's Core Promise: Swap Anything
