# Tài liệu tham khảo Providers — openbnc
...
3. Biến môi trường dự phòng chung: `OPENBNC_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, openbnc gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, openbnc trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `openbnc models refresh --provider nvidia`
