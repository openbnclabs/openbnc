...
|---------|-----------|--------------|--------|
| **openbnc cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | openbnc (cơ bản) | openbnc (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, openbnc chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của openbnc: hoán đổi bất kỳ thứ gì
