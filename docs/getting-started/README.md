...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `openbnc onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `openbnc onboard --interactive` |
| Config exists, just fix channels | `openbnc onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `openbnc onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `openbnc onboard --api-key "sk-..." --provider openrouter`
- Interactive onboarding: `openbnc onboard --interactive`
...
- Validate environment: `openbnc status` + `openbnc doctor`
