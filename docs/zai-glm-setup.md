...
openbnc supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current openbnc provider behavior.

## Overview

openbnc supports these Z.AI aliases and endpoints out of the box:
...
### Test with openbnc CLI

```bash
# Test agent directly
echo "Hello" | openbnc agent
