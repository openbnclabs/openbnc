...
## Problem
openbnc logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/openbnc/audit.key"
...
openbnc audit --user @alice

# Show all high-risk commands
openbnc audit --risk high

# Show violations from last 24 hours
openbnc audit --since 24h --violations-only

# Export to JSON for analysis
openbnc audit --format json --output audit.json
