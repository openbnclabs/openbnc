"""
Tests for openbnc-tools package.
"""
...
def test_cli_allows_interactive_without_message():
    ...
    from openbnc_tools.__main__ import parse_args
...
async def test_invoke_in_event_loop_raises():
    ...
    from openbnc_tools import create_agent, shell
...
async def test_shell_tool():
    ...
    from openbnc_tools import shell
...
async def test_file_tools(tmp_path):
    ...
    from openbnc_tools import file_read, file_write
