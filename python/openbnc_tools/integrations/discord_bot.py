"""
Discord bot integration for openbnc.
"""
...
class DiscordBot:
    """
    Discord bot powered by openbnc agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install openbnc-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"openbnc Discord Bot ready: {self.client.user}")
