...
Gói Python đồng hành cho [openbnc](https://github.com/openbnclabs/openbnc) — gọi công cụ dựa trên LangGraph cho thực thi agent LLM nhất quán.
...
| Tính năng | Rust openbnc | openbnc-tools |
|---------|---------------|----------------|
...
Dùng **Rust openbnc** cho triển khai biên (edge) trong sản phẩm. Dùng **openbnc-tools** khi cần đảm bảo tính nhất quán gọi công cụ hoặc tích hợp hệ sinh thái Python.
